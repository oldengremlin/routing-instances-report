...
Результуючий HTML містить три індексних розділи та основну таблицю:
...
| Рівень  | Що логується |
|---------|--------------|
| `INFO`  | Список хостів при старті · підключення до кожного маршрутизатора · кількість розібраних instance · розмір словника lo0-адрес · кожен рядок підсумкової таблиці · шлях до файлу звіту |
...
└── src/main/java/net/ukrhub/routing/instances/report/
    ...
    └── ReportGenerator.java            генератор HTML-звіту з трьома індексами
```
