...
- **впорядкований список** VRF/VPLS, відсортованих за числовим добутком RD (AS × ID),
  з двонаправленими anchor-посиланнями;
- **таблиця** з типом, назвою, RD і переліком маршрутизаторів для всіх зібраних типів.
